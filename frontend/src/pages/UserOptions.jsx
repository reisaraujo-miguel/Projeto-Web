    ...
    function updateUser() {
        ...
        const data = {
            ...
            "address": {
                ...
                "number": parseInt((number === '' ? result.address.number : number))
            },
            "isAdmin": false
        };
            ...
            <div className="user-wrapper">
                ...
                <div className="gap-2">
                    <form ref={formRef}>
                        ...
                        <div className="inputbox-wrapper">
                            <InputBox inputType="number" placeholder={(result === null) || (result.phone === null) ? "Phone" : result.phone} setData={setPhone} />
                        </div>

                        <div className="inputbox-wrapper">
                            <InputBox inputType="number" placeholder={(result === null) || (result.address.cep === null) ? "CEP" : result.address.cep} setData={setCEP} />
                        </div>


                        <div className="inputbox-wrapper">
                            <InputBox inputType="text" placeholder={(result === null) || (result.address.bairro === "") ? "District" : result.address.bairro} setData={setBairro} />
                        </div>
                        <div className="inputbox-wrapper">
                            <InputBox inputType="number" placeholder={(result === null) || (result.address.number === null) ? "Number" : result.address.number} setData={setNumber} />
                        </div>
