        ...
        <div className="gap-2">
          <form ref={formRef}>
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="text"
                placeholder={result === null ? "Email" : result.email}
                setData={setEmail}
              />
            </div>
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="text"
                placeholder={result === null ? "Username" : result.username}
                disabled={true}
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="text"
                placeholder={result === null ? "CPF" : result.cpf}
                disabled={true}
                backgroundColor="#e3e3e3"
              />
            </div>
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="number"
                placeholder={
                  result === null || result.address.cep === null
                    ? "CEP"
                    : result.address.cep
                }
                setData={setCEP}
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="text"
                placeholder={
                  result === null || result.address.bairro === ""
                    ? "District"
            ...
            <div className="inputbox-wrapper">
              <InputBox
                inputType="number"
                placeholder={
                  result === null || result.address.number === null
                    ? "Number"
