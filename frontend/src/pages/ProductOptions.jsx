          ...
          <div className="gap-2">
            <form ref={modifyFormRef}>
              ...
              <div className="inputbox-wrapper">
                <InputBox
                  inputType="text"
                  placeholder={result === null ? "Name" : result.name}
                  setData={setNameUpdate}
                />
              </div>
              <div className="inputbox-wrapper">
                <InputBox
                  inputType="text"
                  placeholder={result === null ? "Slug" : result.slug}
                  setData={setSlugUpdate}
                />
              </div>
              ...
              <div className="inputbox-wrapper">
                <InputBox
                  inputType="text"
                  placeholder={
                    result === null ? "Description" : result.description
                  }
                  setData={setDescUpdate}
                />
              </div>
              ...
              <div className="inputbox-wrapper">
                <InputBox
                  inputType="text"
                  placeholder={result === null ? "Price" : result.price}
              ...
              <div className="inputbox-wrapper">
                <InputBox
                  inputType="text"
                  placeholder={result === null ? "Quantity" : result.quantity}
                  setData={setQntUpdate}
                />
              </div>
            </form>
          </div>
