      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          >
            ...
            <b style={{ color: "white" }}>{isLogged ? "Logout" : "Login"}</b>
          </button>
        </div>
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-start flex-grow-1 pe-3">
              ...
              <li className="nav-item">
                <a
                  className={
                    "nav-link " + (current === "/checkout" ? "active" : "")
                  }
                  href="/checkout"
                >
                  Cart
              ...
              <li className="nav-item">
                <a
                  className={
                    "nav-link " + (current === "/signup" ? "active" : "")
                  }
                  href="/signup"
                >
                  Sign Up
